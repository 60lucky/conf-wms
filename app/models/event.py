...
class Event(Base):
    ...
    reg_open: Mapped[dt.date] = mapped_column(DateTime, unique=True)
    reg_close: Mapped[dt.date] = mapped_column(DateTime, unique=True)
    event_start: Mapped[dt.date] = mapped_column(DateTime, unique=True) 
